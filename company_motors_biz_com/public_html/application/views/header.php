...
<header class="product-motors-header">
  <div class="product-motors-top">
    <div class="product-motors-top-nav">
      <div class="product-motors-welcome">Welcome to <?php echo $site['site_name'];?></div>
  ...
  <div class="product-motors-logo-search">
    <div class="product-motors-logo"><a href="<?php echo $site['main_domain']?>"><img src="<?php echo base_url('/skin/images/motors-logo.png')?>" class="image-fluid"></a></div>
    <div class="product-motors-sousuo">
      <div class="product-motors-search ">
        ...
        <form action="<?php echo main_url(site_url("search/".$kw));?>" method="post" id="fast_search" name="fast_search">
  ...
  <div class="product-motors-nav">
    <div class="product-motors-navbar product-motors-collapse" role="navigation">
      <ul>
        <li><a href="<?php echo $site['main_domain']?>"><i class="fa fa-home fa-2x fa-color fl"></i>Home</a></li>
        <li><a href="<?php echo main_url(site_url("news/index"));?>" >Information</a></li>
        <li><a href="<?php echo main_url(site_url('company/suppliers'));?>" >Suppliers</a></li>
        <li><a href="<?php echo main_url(site_url('news/newsList/28'));?>" >Exhibition</a></li>
      </ul>
    </div>
  </div>
