...
class News_model extends MY_Model{
     ...
     * @return array
     */
    public function getNewsDetail($catid){
        return $this->getNewsCommonLink('t1.title,t2.content,t1.thumb,t1.itemid',array('wl_news'=>'t1'),array('NewsData'=>'t2'),"t1.catid='{$catid}'",'addtime DESC','0,10','');
    }
