...
class Category_value_model extends MY_Model{
     ...
     * @return array
     */
    public function getValueCommonLink($files = '*', $manTable, $link, $where = '', $order = '', $limit = '', $type = 0)
    {
    ...
    //属性产品
    public function getValue($files,$catid,$country,$order,$group,$limit)
    {
        $value = $this->getValueCommonLink($files,array('wl_category_value'=>'t1'),array('CategoryOption'=>'t2','Sell'=>'t3'),'t2.catid ='.$catid.' and t2.name = '."'".$country."'",$order,$group,$limit,'');
        return $value;
    }
