...
| -------------------------------------------------------------------*/
	...
	$config['site_file'] = 'www_motorsbiz_com';
	$config['admin_site_file'] = 'admin_motorsbiz_com';
	$config['company_site_file'] = 'company_motorsbiz_com';
	
//	$config['main_path'] = '/webimage/img/';
    $config['main_path'] = '/local_motors/webimage/img/';
...
| -------------------------------------------------------------------*/
	...
	$config['allowed_types'] = 'gif|jpg|png|application/octet-stream';
