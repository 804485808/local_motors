...
{ 
    ...
    function Imagewater($images) 
    { 
		$groundImage = $images['groundImage'];
		$waterType = $images['waterPosType'];
    ...
    { 
        ...
        if($this->groundImageWidth < 10 or $this->groundImageHeight < 10) 
        { 
    ...
    function setWaterTextInfo($waterText = "phpup.com",$waterTextColor = "#000000", $waterTextSize = "5", $waterTextFont = "./include/BRITANIC.TTF") 
    { 
        $this->waterType     =  0; 
		...
		if(false == file_exists($this->waterTextFont)) 
        { 
            $this->throwError("textfont404"); 
        } 
