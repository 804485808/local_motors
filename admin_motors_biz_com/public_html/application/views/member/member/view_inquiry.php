...
<tbody><tr>
<td width="10">&nbsp;</td>
<td id="Tab0" class="<?php echo $class=='all' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list/".$username);?>">所有询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab2" class="<?php echo $class=='need' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list1/".$username);?>">未审核询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab3" class="<?php echo $class=='approved' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list2/".$username);?>">已通过的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab5" class="<?php echo $class=='unapproved' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list3/".$username);?>">未通过的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab6" class="<?php echo $class=='unfinished' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list4/".$username);?>">未联系的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab7" class="<?php echo $class=='rejected' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list5/".$username);?>">联系被拒的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab8" class="<?php echo $class=='finished1' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list6/".$username);?>">已联系(有意向)的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab9" class="<?php echo $class=='finished2' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list7/".$username);?>">已联系(无意向)的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab10" class="<?php echo $class=='finished3' ? 'tab_on' : 'tab';?>"><a href="<?php echo site_url("module/inquiry/view_list8/".$username);?>">已联系(意向不明)的询单</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab11" class="tab"><a href="<?php echo site_url("member/member/get_detail/".$username);?>">返回</a></td><td class="tab_nav">&nbsp;</td>
</tbody></table>
</td>
<td width="110">
<div>
