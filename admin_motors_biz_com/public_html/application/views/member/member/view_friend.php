...
<tbody><tr>
<td width="10">&nbsp;</td>
<td id="Tab0" class="tab_on"><a href="<?php echo site_url("member/friend/view_list/".$username);?>">商友列表</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab2" class="tab"><a href="<?php echo site_url("member/member/get_detail/".$username);?>">返回</a></td><td class="tab_nav">&nbsp;</td>
</tr>
</tbody></table>
</td>
<td width="110"><div>
...
<td align="left">&nbsp;
<?php if ($v['tname']){?>
<a href="<?php echo site_url("member/friend/view_list/".$username."/tid-".$v['typeid'])?>"><?php echo $v['tname'];?></a>
<?php }?></td>
...
<?php }?></td>
<td><a href="<?php echo site_url("member/member/get_detail/{$v['myname']}");?>"><?php echo $v['userid']?></a></td>
