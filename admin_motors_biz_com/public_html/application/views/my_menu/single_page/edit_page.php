...
$(function (){
	$("#levelselect").find("option").eq(<?php echo $page['level']?>).attr("selected","selected"); 
})
</script>
</head>
<body>
...
<input name="itemid" value="<?php echo $page['itemid']?>" type="hidden">
<div class="tt">修改单页</div>
<table class="tb" cellpadding="2" cellspacing="1">
<tbody><tr>
<td class="tl"><span class="f_red">*</span> 单页标题</td>
<td><input name="post[title]" id="title" size="50" value="<?php echo $page['title']?>" type="text"> 
...
<input name="post[style]" id="color_input_1" value="<?php echo $page['style']?>" type="hidden">
<img src="<?php echo base_url("skin/images/color.gif")?>" id="color_img_1" style="cursor:pointer;background:<?php echo $page['style']?>;" onclick="color_show(1, Dd('color_input_1').value, this);" height="18" align="absmiddle" width="21">&nbsp; 
<select name="post[level]" id="levelselect"><option value="0">级别</option>
<option value="1">1 级</option><option value="2">2 级</option><option value="3">3 级</option>
<option value="4">4 级</option><option value="5">5 级</option><option value="6">6 级</option>
<option value="7">7 级</option><option value="8">8 级</option><option value="9">9 级</option></select> &nbsp;
<br><span id="dtitle" class="f_red"></span></td>
</tr>
<tr id="link">
<td class="tl"><span class="f_red">*</span> 链接地址</td>
<td><input name="post[linkurl]" id="linkurl" size="100" value="<?php echo $page['linkurl']?>" type="text"> 
...
<td>
<textarea name="post[content]" rows="20" cols="100" id="content"><?php echo $page['content']?></textarea>
</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 绑定域名</td>
<td><input name="post[domain]" size="60" type="text" value="<?php echo $page['domain']?>"> <img src="<?php echo base_url("skin/images/help.png")?>" title="例如设置的生成路径为machine/index.html&lt;br/&gt;那么可以绑定machine.xxx.com至machine目录&lt;br/&gt;此处填写http://machine.xxx.com/" alt="tips" class="c_p" onclick="Dconfirm(this.title, '', 450);" height="11" width="11"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> SEO标题</td>
<td><input name="post[seo_title]" size="60" type="text" value="<?php echo $page['seo_title']?>"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> SEO关键词</td>
<td><input name="post[seo_keywords]" size="60" type="text" value="<?php echo $page['seo_keywords']?>"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> SEO描述</td>
<td><input name="post[seo_description]" size="60" type="text" value="<?php echo $page['seo_description']?>"></td>
</tr>
</tbody>
<tbody><tr>
<td class="tl"><span class="f_hid">*</span> 分组标识</td>
<td><input name="post[item]" size="10" value="<?php echo $page['item']?>" type="text"> 
<img src="<?php echo base_url("skin/images/help.png")?>" title="单页的分组标识，如果不理解含义，请勿修改" alt="tips" class="c_p" onclick="Dconfirm(this.title, '', 450);" height="11" width="11"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 内容模板</td>
<td><span id="destoon_template_1"><select name="post[template]">
<option selected="selected" value="">默认模板</option></select></span>&nbsp;&nbsp;
<a href="javascript:tpl_edit('webpage',%20'extend',%201);" class="t">[修改]</a> &nbsp;
<a href="javascript:tpl_add('webpage',%20'extend');" class="t">[新建]</a></td>
</tr>
</tbody></table>
<div class="sbt"><input name="submit" value=" 确 定 " class="btn" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;<input name="reset" value=" 重 置 " class="btn" type="reset"></div>
</form>
<script type="text/javascript" src="<?php echo base_url("skin/js/clear.js")?>"></script><script type="text/javascript">
function check() {
	var l;
	var f;
	f = 'title';
