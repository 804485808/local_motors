...
<tr>
<td width="10">&nbsp;</td>
<td id="Tab0" class="tab_on"><a href="<?php echo site_url("my_menu/page_style/style_edit/".$findstyle['id']);?>">修改风格</a></td><td class="tab_nav">&nbsp;</td>
...
<form method="post" action="<?php echo site_url("my_menu/page_style/style_edit/".$findstyle['id']);?>" id="dform" onsubmit="return check();">
<div class="tt">修改风格</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tbody>
<tr>
<td class="tl"><span class="f_red">*</span> 风格名称</td>
<td><input name="title" type="text" id="title" size="30" value="<?php echo $findstyle['title']?>"> <span>风格名称为数字、字母、"-"、"_"组合</span><span id="dtitle" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 风格目录</td>
<td><input name="skin" type="text" id="skin" size="30" value="<?php echo $findstyle['skin']?>"> <span>请上传预览图至 ./skin/styles/ 名称为数字、字母、"-"、"_"组合</span><span id="dtitle" class="f_red"></span></td>
</tr>
</tbody></table>
