...
<tbody><tr>
<td width="10">&nbsp;</td>
<td id="Tab0" class="tab"><a href="<?php echo site_url("module/sell/add_sell2")?>">添加供应</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab1" class="tab"><a href="<?php echo site_url("module/sell/sell_list2")?>">供应列表</a></td><td class="tab_nav">&nbsp;</td>
...
<td id="Tab6" class="tab_on"><a href="<?php echo site_url("module/sell/move_cat2")?>">移动分类</a></td><td class="tab_nav">&nbsp;</td></tr>
</tbody></table>
</td>
<td width="110"><div>
...
<form method="post" id="dform" action="<?php echo site_url("module/sell/move_sell_cat")?>" onsubmit="return check();">
<input name="moduleid" value="5" type="hidden">
<input name="file" value="index" type="hidden">
<input name="action" value="move" type="hidden">
<div class="tt">移动分类</div>
...
<tr>
<td title="多个ID用,分开 结尾和开头不能有," align="center" width="220">
<textarea style="height:300px;width:200px;" name="fromids" id="itemid"><?php echo $itemid?></textarea>
<br/>
<span id="ditemid" class="f_red"></span>
</td>
...
<tr>
<td>&nbsp;&nbsp;&nbsp;<a href="<?php echo site_url("module/sell/cat_list2")?>" target="_blank" class="f_b t">分类ID查询</a></td>
<td> </td>
<td><input name="submit" value=" 移 动 " class="btn" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;
<input name="reset" value=" 重 置 " class="btn" type="reset"></td>
</tr>
</tbody></table>
