...
$(function(){
	$("#catid").val(<?php echo isset($parid)?$parid:0?>);
});
</SCRIPT>
</head>
<body>
...
<tbody><tr>
<td width="10">&nbsp;</td>
<td id="Tab0" class="tab_on"><a href="<?php echo site_url("module/sell/add_cat2")?>">添加分类</a></td><td class="tab_nav">&nbsp;</td>
<td id="Tab1" class="tab"><a href="<?php echo site_url("module/sell/cat_list2")?>">管理分类</a></td><td class="tab_nav">&nbsp;</td></tr>
</tbody></table>
</td>
<td width="110"><div>
...
</div><form method="post" action="<?php echo site_url("module/category/save_cat")?>" onsubmit="return check();">
...
function check() {
	...
	if(Dd('catname').value.length > 2000) {
