...
class News_model extends MY_Model{
    ...
    public function getNewsDetail($catid,$limit){
        return $this->getNewsCommonLink('t1.title,t2.content,t1.thumb,t1.itemid',array('wl_news'=>'t1'),array('NewsData'=>'t2'),"t1.catid='{$catid}'",'addtime DESC',$limit,'');
    }
    ...
    public function getNewsHot($limit){
        $newsHot = $this->getNewsCommonLink('t1.catid,t1.addtime,t1.author,t1.title,t1.thumb,t1.itemid,t1.hits,t2.content',array('wl_news'=>'t1'),array('NewsData'=>'t2'),"",'hits DESC',$limit,'');
        return $newsHot;
    ...
    public function getNews($title,$limit){
        $newsHot = $this->getNewsCommonLink('t1.catid,t1.addtime,t1.author,t1.title,t1.thumb,t1.itemid,t1.hits,t2.content',array('wl_news'=>'t1'),array('NewsData'=>'t2'),"title like '".$title."'",'hits DESC',$limit,'');
        return $newsHot;
     ...
     * @return array
     */
    public function getNewsRecommend($level,$limit){
        $newsHot = $this->getNewsCommonLink('t1.catid,t1.addtime,t1.author,t1.title,t1.thumb,t1.itemid,t1.hits,t2.content',array('wl_news'=>'t1'),array('NewsData'=>'t2'),'t1.level ='.$level,'',$limit,'');
        return $newsHot;
    ...
    public function getDetail($itemid){
        return $this->getNewsCommonLink('t1.catid,t1.addtime,t1.author,t1.title,t1.thumb,t1.itemid,t1.hits,t2.content',array('wl_news'=>'t1'),array('NewsData'=>'t2'),"t1.itemid='{$itemid}'",'','','1');
    }
    ...
    public function getNewsTop($limit){
        return $this->getNewsCommon('title,itemid,thumb,hits','level=1','hits desc',$limit);
    }
