    ...
    <div class="motors-suppliersLast Suooliers_margin">
        <div class="Suooliers_left">
                ...
                <div class="Suooliers_boby">
                    <ul>
                        <?php foreach($category_type as $v){ ?>
                            <li><a href="<?php echo site_url("company/search/Category_{$conent}_{$v['catid']}");?>" title="<?php echo $v['catname'];?>"><?php echo $v['catname'];?>
                                    <i>(<?php echo $v['num']; ?>)</i></a></li>
                        <?php } ?>
                    </ul>
                </div>
                ...
                <div class="Suooliers_boby">
                    <ul>
                        <?php foreach($markets_type as $k => $v){ ?>
                            <li><a href="<?php echo site_url("company/search/Markets_{$conent}_{$k}");?>" title="<?php echo $k;?>">
                                    <?php echo $k;?> <i>(<?php echo $v;?>)</i></a></li>
                        <?php } ?>
                    </ul>
                </div>
                <div class="Suooliers_more"> <span>More</span><i class="fa fa-caret-down"></i> </div>
            ...
            <div class="Suooliers_Category">
                ...
                <div class="Suooliers_boby">
                    <ul>
                        <?php foreach($business_type as $k=>$v){ ?>
                            <li><a title="<?php echo $k;?>" href="<?php echo site_url("company/search/Business_{$conent}_{$k}");?>"><?php echo mb_substr($k,0,20,'utf-8')?>
                                    <i>(<?php echo $v;?>)</i></a></li>
                        <?php } ?>
                    </ul>
                </div>
            ...
            <div class="Suooliers_Category">
                ...
                <div class="Suooliers_boby">
                    <ul>
                        <?php foreach($volume_type as $k=>$v){ ?>
                            <li><a title="<?php echo $k;?>" href="<?php echo site_url("company/search/Volume_{$conent}_{$k}");?>"><?php echo mb_substr($k,0,20,'utf-8')?>
                                    <i>(<?php echo $v;?>)</i></a></li>
                        <?php } ?>
                    </ul>
                </div>
            ...
            <div class="Suooliers_Category">
                ...
                <div class="Suooliers_boby">
                    <ul>
                        <?php foreach($country_type as $k=>$v){ ?>
                            <li><a title="<?php echo $k;?>" href="<?php echo site_url("company/search/Country_{$conent}_{$k}");?>"><?php echo mb_substr($k,0,20,'utf-8')?>
                                    <i>(<?php echo $v;?>)</i></a></li>
                        <?php } ?>
                    </ul>
                </div>
                ...
                <?php foreach($new_sell as $v => $o) {?>
                    <div class="sup_proprice">
                        <div class="sup_proimg"><a href="<?php echo site_url('sell_detail/index/'.$o['itemid'].'/'.$o['linkurl']);?>">
                                <img src="<?php echo base_url('/skin/images/nopic.jpg')?>" data-src="<?php echo $site['image_domain'].$o['thumb']?>" class="image-fluid" alt=" "></a></div>
            ...
            <div class="Suooliers_Screening">
                ...
                <div class="searchbox">
                    <div class="input-group">
                        <input type="text" class="form-control Suooliers_search" value="<?php echo $conent;?>" >
                ...
                <div class="sup_Hotsearch_content">
                    <ul>
                        <?php foreach($category_hot_type as $v){ ?>
                            <li><a href="<?php echo site_url("company/suppliers/Category_{$conent}_{$v['catid']}");?>" title="<?php echo $v['catname'];?>"><?php echo $v['catname'];?>
                                    <i></i></a></li>
                        <?php } ?>
                    </ul>
                </div>
                                ...
                                <?php foreach($v['sell'] as $k=>$v){?>
                                    <div class="Supplers_Product_display">
                                        <div class="Supplers_Product"><a href="<?php echo site_url('sell_detail/index/'.$v['itemid'].'/'.$v['linkurl'])?>">
                                                <img src="<?php echo base_url('/skin/images/nopic.jpg')?>" data-src="<?php echo $site['image_domain'].$v['thumb']?>" class="image-fluid" alt=""></a></div>
                                        <span><a href="<?php echo site_url('sell_detail/index/'.$v['itemid'].'/'.$v['linkurl'])?>" title="<?php echo $v['title']?>"><?php echo $v['title'];?></a></span> </div>
                                <?php }?>
                            </div>
                                ...
                                <?php foreach($hot_pros as $v => $o) {?>
                                    <div class="suppliers_Hotproductlast">
                                        <div class="suppliers_Hotproductimg"><a href="<?php echo site_url('sell_detail/index/'.$o['itemid'].'/'.$o['linkurl'])?>">
                                                <img src="<?php echo base_url('/skin/images/nopic.jpg')?>" data-src="<?php echo $site['image_domain'].$o['thumb']?>" class="image-fluid" alt=" "></a></div>
                                        <span title="<?php echo $o['title'];?>"><a href="<?php echo site_url('sell_detail/index/'.$o['itemid'].'/'.$o['linkurl'])?>" ><?php echo mb_substr($o['title'],0,25,'utf-8')?></a></span>
                                    </div>
                                <?php } ?>
                            </li>
                        </ul>
...
<script>
    $(function(){
        ...
        $(".Suooliers_select").change(function(){
            window.location.href="<?php echo $thisUrl1?>"+$(this).val();
        })
    })
</script>