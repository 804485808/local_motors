...
<!--Header start-->
<header class="motors-header">
    <div class="motors-top">
        <div class="motors-top-nav">
            <div class="motors-welcome">Welcome to <?php echo $site['site_name'];?>, <?php echo $username ? $username : "Guest";?>!</div>
            <div class="motors-top-nav-right">
                <ul>
                    <?php if(!$username):?>
    ...
    <div class="motors-logo-search">
        <div class="motors-logo"><a href="/"><img src="<?php echo base_url('/skin/images/motors-logo.png')?>" class="image-fluid"></a></div>
        <div class="motors-sousuo">
            <div class="motors-search">
                <!--Search classification-->
                <div class="motors-dropdown" id="dropdown">
                    <div class="btn-color" id="btn-meun">All <span class="carets">▼</span> </div>
                    <ul class="motors-last" id="last">
                    <li><a href="#">All</a></li>
                ...
                <div class="motors-text">
                    <input type="text" placeholder="Please enter the content you want to search" name="input_text" id="input_text" class="motors-input"
                           required oninvalid="setCustomValidity('Required field!');" oninput="setCustomValidity('');" type="text" autocomplete value="<?php echo $kw;?>">
                </div>
                </form>
            </div>
            <!--Search button-->
            <div class="motors-btnsearch"><i class="fa fa-search fa-lg motors-hidden"></i><span onclick="search_sub()">Search</span></div>
            <div class="clear"></div>
            <div class="motors-hotSearch">
                <ul>
    ...
    <div class="motors-nav">
        <div class="motors-navbar motors-collapse" role="navigation">
            <ul>
