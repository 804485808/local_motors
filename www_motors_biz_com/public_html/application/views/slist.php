...
<div class="product_detailsmian">
  <div class="motors-ProductDetailspage">
    <div class="product_Hierarchy product_Hierarchy_margin"> <span> <a href="<?php echo main_url(site_url());?>">Home</a> » <a href="<?php echo site_url("sell_list/index/catid_".$nowcat['catid']."/".$nowcat['linkurl'])?>" id="M_menu"><?php echo $nowcat['catname']?>»</a> <?php echo $thistag['tag']?> </span>
        ...
        <div class="product_AllBrand">
          ...
          <div class="product_Attributes_last">
            <ul>
              ...
              <li><a href="<?php echo site_url("slist/index/".$thistag['id']."/cid_0_".$thistag['linkurl']."_oid_".$vv['id'])?>"  rel="nofollow"><?php echo $vv['value']?>(<?php echo $vv['cnum']?>)</a></li>
              <?php }?>
            </ul>
        ...
        <div class="Commodity_totalList">
          ...
          <div class="Commodity_right">
            ...
            <div class="productlast_EMail" data-toggle="modal" data-target="#myModal">
              <div href="" class="productlast_button"><i class="fa fa-envelope glyphicon-size"></i>Contact Now</div>
            </div>
